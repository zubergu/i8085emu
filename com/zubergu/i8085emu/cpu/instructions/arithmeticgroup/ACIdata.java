...
public class ACIdata implements Instruction {
	private String description = "";
	private Cpu cpu;
	
	public ACIdata(Cpu cpu) {
		this.cpu = cpu;
	}
	...
	public int execute() {
		...
		int result = accumulator.getValue() + byte2 + carry;
		cpu.setCarryFlag(accumulator.getValue(), byte2 + carry, false);
		cpu.setAuxiliaryCarryFlag(accumulator.getValue(), byte2 + carry, false);
