...
public class SUBM implements Instruction {
	...
	public int execute() {
		...
		cpu.setCarryFlag(accumulator.getValue(), memory.readByte(hl.getValue()), true);
		cpu.setAuxiliaryCarryFlag(accumulator.getValue(), memory.readByte(hl.getValue()), true);
