...
public class ADIdata implements Instruction {

	private String description = "";
	private Cpu cpu;
	
	public ADIdata(Cpu cpu) {
		this.cpu = cpu;
	}
	...
	public int execute() {
		...
		cpu.setCarryFlag(accumulator.getValue(), byte2, false);
		cpu.setAuxiliaryCarryFlag(accumulator.getValue(), byte2, false);
